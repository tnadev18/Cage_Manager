...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    cageManagerAuthUserSubject.add(
      CageManagerAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<CageManagerAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  CageManagerAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = CageManagerAuthUser(
      loggedIn: true,
      uid: authUid,
    );
    cageManagerAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
...
CageManagerAuthUser? currentUser;
