              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  image: DecorationImage(
                    fit: BoxFit.cover,
                    image: Image.network(
                      'https://images.unsplash.com/photo-1507041957456-9c397ce39c97?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NTYyMDF8MHwxfHNlYXJjaHw1fHxmb3Jlc3R8ZW58MHx8fHwxNzIyMzQ3Mzk1fDA&ixlib=rb-4.0.3&q=80&w=1080',
                    ).image,
                  ),
                ),
                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                                    ...
                                    child: FFButtonWidget(
                                      onPressed: () async {
                                        ...
                                        _model.getUserData =
                                          ...
                                          uid: LoginUserCall.uid(
                                            (_model.loginResponse?.jsonBody ??
                                                ''),
                                          ),
                                        );

                                        if (LoginUserCall.success(
                                          (_model.loginResponse?.jsonBody ??
                                              ''),
                                        )!) {
                                          GoRouter.of(context)
                      ...
                      Padding(
                        padding:
                            const EdgeInsetsDirectional.fromSTEB(0.0, 5.0, 0.0, 7.0),
                        child: RichText(
